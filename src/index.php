...
<ul>
    ...
    <li><a href="vuln/auth_vuln.php">Auth session (vuln)</a></li>
    <li><a href="vuln/del_vuln.php">Suppression GET (CSRF vuln)</a></li>
    <li><a href="vuln/parse_vuln_xml.php">XXE vuln (XML)</a></li>
</ul>

<?php 
echo '<p>Fichier source PPTX utilisé : /upload/21976203-f3c2-4002-b1a7-f7a28952c8d9.pptx</p>'; 
?>
